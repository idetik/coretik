...
class Mimes
{
    ...
    public static function getType(string $ext): ?array
    {
        if (!self::validType($ext)) {
            return null;
        }
    ...
    public static function validType(string $ext): bool
    {
        return \array_key_exists($ext, self::$mimes);
    }
}